...
const postData = [
  ...
  },
  {
    ...
    date: "2023-06-06",
    description: "Uncover the Legends of the Ancient Kingdom as you embark on a quest through time. Journey back to a bygone era of knights, castles, and noble quests. Follow in the footsteps of legendary heroes, solve intricate puzzles, and decipher cryptic codes. As you traverse majestic landscapes and encounter mythical creatures, the tales of old will come to life before your very eyes. Prepare to be swept away by the rich history and grandeur of the Ancient Kingdom.",
    img: getRandomImage()
  },
  {
    id: 7,
  ...
  },
  {
    ...
    date: "2023-06-09",
    description: "Saddle up and ride into the sunset on The Wild West Adventure. Step back in time to the era of cowboys, outlaws, and untamed frontier. Experience the thrill of the open plains, the ruggedness of the mountains, and the excitement of the wild frontier. Test your skills in a high-stakes poker game, embark on a daring stagecoach chase, and witness epic showdowns in dusty saloons. Get ready to live out your wildest Western fantasies in this action-packed escapade.",
    img: getRandomImage()
  },
  {
    id: 10,
